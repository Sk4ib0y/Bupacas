...
public class AdaptadorSoporte extends BaseAdapter {
    Context contexto;
    String texto1[];
    int imagen[];
    LayoutInflater inflater;

    public AdaptadorSoporte(Context contexto, String[] texto1, int[] imagen)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = inflater.inflate(R.layout.modelosoporte, null);
