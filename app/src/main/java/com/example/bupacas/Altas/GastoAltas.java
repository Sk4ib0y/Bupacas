...
public class GastoAltas extends AppCompatActivity implements View.OnClickListener {
    ...
    private void crearGasto()
    {
        ...
        RetrofitClient.getGastoService().createGasto(gastoDTO)
                .enqueue(new Callback<GastoDTO>() {
                    ...
                    public void onResponse(Call<GastoDTO> call, Response<GastoDTO> response) {
                        ...
                        if (response.isSuccessful()) {
                            Toast.makeText(GastoAltas.this, "Gasto añadido correctamente", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(GastoAltas.this, mensajeError, Toast.LENGTH_LONG).show();
                        }
                    }
                    ...
                    public void onFailure(Call<GastoDTO> call, Throwable throwable) {
                        progressDialog.dismiss();
                        Toast.makeText(GastoAltas.this, "Error de conexion", Toast.LENGTH_SHORT).show();
                    }
                });
