...
public class DatosCliente extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        else if(id==telefono.getId() && telefono.getText().equals("Cliquea para añadir un teléfono"))
        {
            ...
            intentito.putExtra("idCliente", idCliente);
    ...
    private void eliminarTelefono() {
        ...
        RetrofitClient.getTelefonoClienteService().deleteTelefonoClte(idTelefono)
                .enqueue(new Callback<Void>() {
                    ...
                    public void onResponse(Call<Void> call, Response<Void> response) {
                        if (response.isSuccessful()) {
                            telefono.setText("Cliquea para añadir un teléfono");
                            idTelefono = -1;
                            Toast.makeText(DatosCliente.this, "Teléfono eliminado", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(DatosCliente.this, "Error al eliminar (código: " + response.code() + ")", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onFailure(Call<Void> call, Throwable t) {
                        Toast.makeText(DatosCliente.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}